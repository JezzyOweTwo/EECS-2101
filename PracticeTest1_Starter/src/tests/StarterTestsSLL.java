...
public class StarterTestsSLL {
	 ...
	 * 	- This test class focuses on the manipulation of singly-linked nodes.
	 ...
	 * 	- You shouldn't need to solve the programming task(s) recursively. 
	 * 		Instead, using conditionals and loops on singly-linked nodes should suffice. 
